...
export default plugin(({ addComponents, theme }) => {
  ...
  addComponents({
    '.container-fixed': {
      ...
      'padding-inline-start': theme(
        'custom.components.container.fixed.px.DEFAULT'
    ...
    [`@media (min-width: ${theme('screens.xl')})`]: {
      '.container-fixed': {
        ...
        'padding-inline-start': theme(
          'custom.components.container.fixed.px.xl'
        ), // Logical property for LTR/RTL
  ...
  addComponents({
    '.container-fluid': {
      ...
      'flex-grow': '1',
      'padding-inline-start': theme(
        'custom.components.container.fluid.px.DEFAULT'
      ), // Logical property for LTR/RTL
      'padding-inline-end': theme(
        'custom.components.container.fluid.px.DEFAULT'
      ), // Logical property for LTR/RTL
    ...
    [`@media (min-width: ${theme('screens.xl')})`]: {
      '.container-fluid': {
        'padding-inline-start': theme(
          'custom.components.container.fluid.px.xl'
        ), // Logical property for LTR/RTL
